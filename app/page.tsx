        ...
        <section className="grid min-h-[720px] items-center gap-14 py-20 lg:grid-cols-[1.15fr_.85fr]">
          <div>
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <button onClick={()=>setStarted(true)} className="flex items-center justify-center gap-2 rounded-xl bg-white px-5 py-3 font-semibold text-black hover:bg-zinc-200">Create a project <ArrowRight size={17}/></button>
